...
BLOCK_WIDTHS = {
  GX.ImageFormat.I4    : 8,
  GX.ImageFormat.I8    : 8,
  GX.ImageFormat.IA4   : 8,
  GX.ImageFormat.IA8   : 4,
  GX.ImageFormat.RGB565: 4,
  GX.ImageFormat.RGB5A3: 4,
  GX.ImageFormat.RGBA8 : 4,
  GX.ImageFormat.C4    : 8,
  GX.ImageFormat.C8    : 8,
  GX.ImageFormat.C14X2 : 4,
  GX.ImageFormat.CMPR  : 8,
}
BLOCK_HEIGHTS = {
  GX.ImageFormat.I4    : 8,
  GX.ImageFormat.I8    : 4,
  GX.ImageFormat.IA4   : 4,
  GX.ImageFormat.IA8   : 4,
  GX.ImageFormat.RGB565: 4,
  GX.ImageFormat.RGB5A3: 4,
  GX.ImageFormat.RGBA8 : 4,
...
BLOCK_DATA_SIZES = {
  GX.ImageFormat.I4    : 32,
  GX.ImageFormat.I8    : 32,
  GX.ImageFormat.IA4   : 32,
  GX.ImageFormat.IA8   : 32,
  GX.ImageFormat.RGB565: 32,
  GX.ImageFormat.RGB5A3: 32,
  GX.ImageFormat.RGBA8 : 64,
  GX.ImageFormat.C4    : 32,
  GX.ImageFormat.C8    : 32,
  GX.ImageFormat.C14X2 : 32,
  GX.ImageFormat.CMPR  : 32,
}

IMAGE_FORMATS_THAT_USE_PALETTES = [
  GX.ImageFormat.C4,
  GX.ImageFormat.C8,
  GX.ImageFormat.C14X2,
]
...
GREYSCALE_PALETTE_FORMATS = [
  GX.PaletteFormat.IA8,
]

MAX_COLORS_FOR_IMAGE_FORMAT = {
  GX.ImageFormat.C4   : 1<<4,
  GX.ImageFormat.C8   : 1<<8,
  GX.ImageFormat.C14X2: 1<<14,
}
BITS_PER_PIXEL = {
    GX.ImageFormat.I4:      4,
    GX.ImageFormat.I8:      8,
    GX.ImageFormat.IA4:     8,
    GX.ImageFormat.IA8:    16,
    GX.ImageFormat.RGB565: 16,
    GX.ImageFormat.RGB5A3: 16,
    GX.ImageFormat.RGBA8 : 32,
    GX.ImageFormat.C4:      4,
    GX.ImageFormat.C8:      8,
    GX.ImageFormat.C14X2:  16,
    GX.ImageFormat.CMPR:    4,
}
...
def decode_palettes(palette_data, palette_format, num_colors, image_format):
  if not isinstance(image_format, GX.ImageFormat):
...
def decode_color(raw_color, palette_format):
  if palette_format == GX.PaletteFormat.IA8:
    color = convert_ia8_to_color(raw_color)
  elif palette_format == GX.PaletteFormat.RGB565:
    color = convert_rgb565_to_color(raw_color)
  elif palette_format == GX.PaletteFormat.RGB5A3:
...
def encode_image_to_block(image_format, pixels, colors_to_color_indexes, block_x, block_y, block_width, block_height, image_width, image_height):
  if image_format == GX.ImageFormat.I4:
    ...
    raise Exception("Unknown image format: %s" % GX.ImageFormat(image_format).name)
